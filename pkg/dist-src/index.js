...
import './iron-resizable-behavior/iron-resizable-behavior.js'; // import { IronA11yAnnouncer } from './iron-a11y-announcer/iron-a11y-announcer.js';
...
import { afterNextRender, beforeNextRender } from '@polymer/polymer/lib/utils/render-status.js'; // import { animationFrame, idlePeriod, microTask } from "@polymer/polymer/lib/utils/async.js";

import { dashToCamelCase } from '@polymer/polymer/lib/utils/case-map.js';
import { dom } from "@polymer/polymer/lib/legacy/polymer.dom.js";
import { enqueueDebouncer, flush } from '@polymer/polymer/lib/utils/flush.js'; //import { flush as flush$1, dom } from '@polymer/polymer/lib/legacy/polymer.dom.js';
...
export { IronA11yAnnouncer, IronA11yKeysBehavior, IronResizableBehavior, IronScrollTargetBehavior, AppLayoutBehavior, AppScrollEffectsBehavior, Base, Debouncer, DisableUpgradeMixin, IronButtonState, IronCheckedElementBehavior, IronControlState, IronFitBehavior, IronFocusablesHelper, IronFormElementBehavior, IronMeta, IronOverlayManager, IronValidatableBehavior, NeonAnimatableBehavior, NeonAnimationRunnerBehavior, OptionalMutableDataBehavior, PaperButtonBehavior, PaperCheckedElementBehavior, PaperDialogBehavior, PaperInkyFocusBehavior, PaperInkyFocusBehaviorImpl, PaperInputAddonBehavior, PaperInputBehavior, PaperRippleBehavior, Polymer, PolymerElement, TemplateInstanceBase, Templatizer, _scrollEffects, addListener, register, prevent, gestures, removeListener, setTouchAction, resetMouseCanceller, afterNextRender, beforeNextRender, animationFrame, idlePeriod, microTask, dashToCamelCase, dom, enqueueDebouncer, html, matches, translate, mixinBehaviors, Class, pushScrollLock, removeScrollLock, resolveUrl, templatize, useShadow, IronOverlayBehavior, IronOverlayBehaviorImpl, flush, DomModule, FlattenedNodesObserver, GestureEventListeners, IronButtonStateImpl, IronCheckedElementBehaviorImpl };